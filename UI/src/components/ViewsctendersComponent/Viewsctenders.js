...
import { _subcategoryapiurl } from '../../APIurls';
...
<h1 class="display-5 mb-4">SubCategory for <span class="text-primary">Tenders &gt;&gt; </span>{params.catnm}</h1>
<center>
<div id="category_main">
{
  sclist.map((row)=>(
  <Link to={`/Viewtenderbysc/${row.subcatnm}`} >
